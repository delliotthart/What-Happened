...
quietly infix                 ///
  ...
  int     bpl        100-102  ///
  long    bpld       103-107  ///
  byte    citizen    108-108  ///
  byte    racamind   109-109  ///
  byte    racasian   110-110  ///
  byte    racblk     111-111  ///
  byte    racpacis   112-112  ///
  byte    racwht     113-113  ///
  byte    racother   114-114  ///
  byte    school     115-115  ///
  byte    educ       116-117  ///
  int     educd      118-120  ///
  byte    empstat    121-121  ///
  byte    empstatd   122-123  ///
  int     poverty    124-126  ///
  byte    migrate1   127-127  ///
  byte    migrate1d  128-129  ///
  byte    vetstat    130-130  ///
  byte    vetstatd   131-132  ///
  using `"usa_00002.dat"'
