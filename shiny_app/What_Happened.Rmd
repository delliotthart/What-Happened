...
```{r Display_KNN_Model, eval=FALSE, include=FALSE}
suppressWarnings(source('scripts/KNN.R'))
...
```{r one_county_neighbors, eval=FALSE, include=FALSE}
  source('scripts/KNN.R')
  counties <- 'Please Select a State'
   #main_data <- get_election_data()
   # Application title
...
```{r one_county_take_two, echo=TRUE}
  source('scripts/KNN.R')
